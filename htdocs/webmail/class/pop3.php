...
/**
 *  \file       webmail/class/pop3.php
 *  \ingroup    webmail
 *  \brief      manage pop3 server
 */
class pop3_class
{
	var $hostname="";
	...
	/**
	 * Statistics method
	 * pass references to variables to hold the number of messages in the mail box and the size that they take in bytes
	 * 
	 ...
	 * @param int $unique_id
	 * @return multitype:number string |Ambigous <number, string>
	 */
	 ...
	 * @param unknown_type $end_of_message
	 * @return string
	 */
	...
	/**
	 * Ping the server to prevent auto-close connection
	 */
	Function IssueNOOP()
	{
		if($this->state!="TRANSACTION")
	...
	/**
	 * Retrive name associated to Pop3 server connection
	 * 
	 * @param unknown_type $connection_name
	 * @return string
	 */
