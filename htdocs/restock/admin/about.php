...
// Libraries
require_once("../core/lib/restock.lib.php");
...
dol_fiche_head($head, 'about', $langs->trans("RestockSetup"), 0, "restock@restock");
...
print '<a href="'.$url.'" target="_blank"><img border="0" width="180" src="'.DOL_URL_ROOT.'/customtabs/img/patas-monkey_logo.png"></a>';
