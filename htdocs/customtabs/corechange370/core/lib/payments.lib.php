...
function payment_salaries_prepare_head($object)
{
	global $langs, $conf;
	...
	// $this->tabs = array('entity:+tabname:Title:@mymodule:/mymodule/mypage.php?id=__ID__');   to add new tab
	// $this->tabs = array('entity:-tabname);   												to remove a tab
	complete_head_from_modules($conf,$langs,$object,$head,$h,'payment_salaries');
	
	
	complete_head_from_modules($conf,$langs,$object,$head,$h,'payment_salaries','remove');
	
	return $head;
}

function payment_vat_prepare_head($object)
{
	global $langs, $conf;
	...
	// $this->tabs = array('entity:+tabname:Title:@mymodule:/mymodule/mypage.php?id=__ID__');   to add new tab
	// $this->tabs = array('entity:-tabname);   												to remove a tab
	complete_head_from_modules($conf,$langs,$object,$head,$h,'payment_vat');


    complete_head_from_modules($conf,$langs,$object,$head,$h,'payment_vat','remove');

    return $head;
}

function payment_localtax_prepare_head($object)
{
	global $langs, $conf;
	...
	// $this->tabs = array('entity:+tabname:Title:@mymodule:/mymodule/mypage.php?id=__ID__');   to add new tab
	// $this->tabs = array('entity:-tabname);   												to remove a tab
	complete_head_from_modules($conf,$langs,$object,$head,$h,'payment_localtax');


	complete_head_from_modules($conf,$langs,$object,$head,$h,'payment_localtax','remove');
