...
<form
	action="<?php echo $_SERVER["PHP_SELF"]; ?>?attrname=<?php echo $attrname; ?>"
	method="post">
	<input type="hidden" name="token"
		value="<?php echo $_SESSION['newtoken']; ?>"> <input type="hidden"
		name="attrname" value="<?php echo $attrname; ?>"> <input type="hidden"
		name="action" value="update"> <input type="hidden" name="rowid"
...
<!-- Label -->
		<tr>
			...
			<td class="valeur"><input type="text" name="label" size="40"
				value="<?php echo $extrafields->attribute_label[$attrname]; ?>"></td>
		</tr>
		<!-- Code -->
		<tr>
...
<input type="hidden" name="type" id="type" value="<?php print $type; ?>">
		...
		<tr>
			...
			<td><input id="size" type="text" name="size" size="5"
		...
		<tr>
			...
			<td class="valeur"><input type="text" name="pos" size="5"
				value="<?php  echo $extrafields->attribute_pos[$attrname];  ?>"></td>
		</tr>
			...
			<td>
				<table class="nobordernopadding">
					<tr>
						...
						<td><?php print $form->textwithpicto('', $langs->trans("ExtrafieldParamHelp".$type),1,0)?></td>
					</tr>
				</table>
			</td>
		</tr>
