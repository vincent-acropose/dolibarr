...
if ($customtabs->getShowCustomtabs($user->id))
{
	...
	*/
	...
	// Suppression fichier pour les anciennes version (inf à 3.6)
	...
	********************************************/
	...
	if (!empty($extrafields->attribute_label))
	{
		...
		if ($customtabs->template)
		{
			...
			// gestion de l'élémentkey si il est actif
			print $template."\n";
		}
		else
		{
	...
	if ($customtabs->element == 'thirdparty') 	$icontabs="company";
	else
