...
// require_once DOL_DOCUMENT_ROOT.'/custom/user2O/class/usergroup2O.class.php';
...
if ($action == 'add')
{
    if ($caneditperms)
    {
		...
		if (! $message)
		{
			...
			$object->office_phone	= trim($_POST["office_phone"]);
			$object->office_phone_alias	= trim($_POST["office_phone_alias"]);
			$object->office_fax	= trim($_POST["office_fax"]);
			$object->office_ips	= trim($_POST["office_ips"]);
...
if ($action == 'create')
{
	...
	if (! empty($conf->multicompany->enabled))
	{
		...
		print "<tr>".'<td valign="top" class="">'.$langs->trans("Tel").'</td>';
// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
	print '<td class="valeur"><input size="20" type="text" name="office_phone" value="'.GETPOST('office_phone').'">';
	print '</td></tr>';
	
	
		print "<tr>".'<td valign="top" class="">'.$langs->trans("TelAlias").'</td>';
// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
	print '<td class="valeur"><input size="20" type="text" name="office_phone_alias" value="'.GETPOST('office_phone_alias').'">';
	print '</td></tr>';
	
	
	print "<tr>".'<td valign="top" class="">'.$langs->trans("Fax").'</td>';
// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
	print '<td class="valeur"><input size="20" type="text" name="office_fax" value="'.GETPOST('office_fax').'">';
	print '</td></tr>';
	
	print "<tr>".'<td valign="top" class="">'.$langs->trans("Ips").'</td>';
// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
	print '<td class="valeur"><input size="20" type="text" name="office_ips" value="'.GETPOST('office_ips').'">';
	print '</td></tr>';
...
else
{
    if ($id)
    {
		...
		print "<tr>".'<td valign="top" class="">'.$langs->trans("Tel").'</td>';
	// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
		print '<td class="valeur">'.$object->office_phone;
		print '</td></tr>';
		
		print "<tr>".'<td valign="top" class="">'.$langs->trans("TelAlias").'</td>';
	// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
		print '<td class="valeur">'.$object->office_phone_alias;
		print '</td></tr>';
		
		
		print "<tr>".'<td valign="top" class="">'.$langs->trans("Fax").'</td>';
	// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
		print '<td class="valeur">'.$object->office_fax;
		print '</td></tr>';
		
		print "<tr>".'<td valign="top" class="">'.$langs->trans("Ips").'</td>';
	// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
		print '<td class="valeur">'.$object->office_ips;
		print '</td></tr>';
		...
		print "<tr>".'<td valign="top" class="">'.$langs->trans("Tel").'</td>';
// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
	print '<td class="valeur"><input size="20" type="text" name="office_phone" value="'.$object->office_phone.'">';
	print '</td></tr>';
	
			print "<tr>".'<td valign="top" class="">'.$langs->trans("TelAlias").'</td>';
// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
	print '<td class="valeur"><input size="128" type="text" name="office_phone_alias" value="'.$object->office_phone_alias.'">';
	print '</td></tr>';
	
	print "<tr>".'<td valign="top" class="">'.$langs->trans("Fax").'</td>';
// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
	print '<td class="valeur"><input size="20" type="text" name="office_fax" value="'.$object->office_fax.'">';
	print '</td></tr>';
	
	print "<tr>".'<td valign="top" class="">'.$langs->trans("Ips").'</td>';
// 	print '<td class="valeur"><input size="30" type="text" id="nom" name="nom" value=""></td></tr>';
	print '<td class="valeur"><input size="20" type="text" name="office_ips" value="'.$object->office_ips.'">';
	print '</td></tr>';
