...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_salaison.modules.php
 *	\ingroup    propale
 *	\brief      Fichier de la classe permettant de generer les propales au modele salaison
 */
...
/**
 *	Class to generate PDF proposal salaison
 */
class pdf_salaison extends ModelePDFPropales
{
	var $db;
	var $name;
	var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "salaison";
		$this->description = $langs->trans('DocModelsalaisonDescription');
