 ...
 */
class pdf_azur_ATM extends ModelePDFPropales
{
	var $db;
	var $name;
	var $description;
		...
		if ($conf->propal->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				*/
				...
				$posy=$this->_signature_area($pdf, $object, 0, $posy, $outputlangs);
	...
	function _tableau_info(&$pdf, $object, $posy, $outputlangs)
	{
		...
		// Show ATM specific mention about deposit
		$pdf->SetFont('','B', $default_font_size - 2);
		$pdf->SetXY($this->marge_gauche, $posy);
	 ...
	 *	@return int							Position pour suite
	 */
	function _signature_area(&$pdf, $object, $deja_regle, $posy, $outputlangs)
	{
		global $conf,$mysoc;
		$default_font_size = pdf_getPDFFontSize($outputlangs);
