...
*/
	...
	{
		$showdetails=0;
		return pdf_pagefoot($pdf,$outputlangs,'CONTRACT_FREE_TEXT',$this->emetteur,$this->marge_basse-25,$this->marge_gauche,$this->page_hauteur,$object,$showdetails,$hidefreetext);
	}
