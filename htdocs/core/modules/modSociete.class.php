...
*/
		...
		$this->export_fields_array[$r] = array (
				...
				's.tms' => "DateLastModification",
				's.code_client' => "CustomerCode",
				's.code_fournisseur' => "SupplierCode",
				's.code_compta' => "AccountancyCode",
		...
		$this->export_TypeFields_array[$r] = array (
				...
				's.status' => "Number",
				's.client' => "Boolean",
				's.fournisseur' => "Boolean",
				's.datec' => "Date",
				's.tms' => "Date",
				's.code_client' => "Text",
				's.code_fournisseur' => "Text",
				's.code_compta' => "Text",
				's.code_compta_fournisseur' => "Text",
				's.address' => "Text",
				's.zip' => "Text",
				's.town' => "Text",
				'p.libelle' => "List:c_pays:libelle:libelle",
				'p.code' => "Text",
				's.phone' => "Text",
				's.fax' => "Text",
				's.url' => "Text",
		...
		if ($resql) // This can fail when class is used on old database (during migration for example)
{
		...
		$this->export_fields_array[$r] = array (
				'c.rowid' => "IdContact",
				'c.civilite' => "CivilityCode",
				'c.lastname' => 'Lastname',
				'c.firstname' => 'Firstname',
				'c.datec' => "DateCreation",
				'c.tms' => "DateLastModification",
				'c.priv' => "ContactPrivate",
				'c.address' => "Address",
				'c.zip' => "Zip",
				'c.town' => "Town",
				'c.phone' => "Phone",
				'c.fax' => "Fax",
				'c.email' => "EMail",
				'c.statut' => "Etat contact actif",
				'p.libelle' => "Country",
				'p.code' => "Code Pays",
				'p.code' => "CountryCode",
				's.rowid' => "IdCompany",
				's.nom' => "CompanyName",
				's.status' => "Etat Tiers actif",
				's.code_client' => "CustomerCode",
				's.code_fournisseur' => "SupplierCode",
				't.libelle' => "ThirdPartyType",
				'userextra.u_code' => 'Code Commerciale' 
		...
		if ($resql) // This can fail when class is used on old database (during migration for example)
{
		...
		$this->import_convertvalue_array[$r] = array (
				's.fk_typent' => array (
						...
						'class' => 'Ctypent',
						'method' => 'fetch',
						'dict' => 'DictionnaryCompanyType' 
				),
				's.fk_pays' => array (
						'rule' => 'fetchidfromcodeid',
						'classfile' => '/core/class/cpays.class.php',
						'class' => 'Cpays',
						'method' => 'fetch',
						'dict' => 'DictionnaryCountry' 
				),
				's.fk_stcomm' => array (
						'rule' => 'zeroifnull' 
				),
				's.code_client' => array (
						'rule' => 'getcustomercodeifnull' 
				),
				's.code_fournisseur' => array (
						'rule' => 'getsuppliercodeifnull' 
				),
				's.code_compta' => array (
						'rule' => 'getcustomeraccountancycodeifnull' 
				),
				's.code_compta_fournisseur' => array (
						'rule' => 'getsupplieraccountancycodeifnull' 
				) 
		);
		...
		$this->import_examplevalues_array[$r] = array (
				's.nom' => "MyBigCompany",
				's.status' => "0 (closed) or 1 (active)",
				's.client' => '0 (no customer no prospect)/1 (customer)/2 (prospect)/3 (customer and prospect)',
				's.fournisseur' => '0 or 1',
				's.datec' => dol_print_date(dol_now(), '%Y-%m-%d'),
				's.code_client' => "CU01-0001 or auto",
				's.code_fournisseur' => "SU01-0001 or auto",
				...
				's.phone' => "0101010101",
				's.fax' => "0101010102",
				's.url' => "http://mycompany.com",
				's.email' => "test@mycompany.com",
				's.siret' => "",
				's.siren' => "",
				's.ape' => "",
				's.idprof4' => "",
				's.tva_intra' => "FR0123456789",
				's.capital' => "10000",
				's.note_private' => "This is an example of private note for record",
				's.note_public' => "This is an example of public note for record",
				's.fk_typent' => "2",
				's.fk_effectif' => "3",
				"s.fk_forme_juridique" => "1",
				's.fk_prospectlevel' => 'PL_MEDIUM',
				's.fk_stcomm' => '0',
				's.default_lang' => 'en_US',
				's.barcode' => '123456789' 
		);
		...
		if ($resql) // This can fail when class is used on old database (during migration for example)
{
		...
		$this->import_examplevalues_array[$r] = array (
				'sr.fk_soc' => "MyBigCompany",
				'sr.bank' => "ING",
				'sr.code_banque' => "0000",
				'sr.code_guichet' => "1111",
				'sr.number' => "3333333333",
				'sr.cle_rib' => "22",
				'sr.bic' => "USHINGMMXXX",
				'sr.iban_prefix' => "US00 0000 1111 22 3333 3333" 
		);
	}
	 ...
	 *
	 * @param string $options when enabling module ('', 'noboxes')
