 ...
 */
class mod_codeproduct_volition extends ModeleProductCode
{
	/*
	...
	var $nom = 'Volition';					// Nom du modele
	...
	function getNextValue($objproduct=0,$type=-1)
	{
		...
		// Récupération de la référence du dernier objet crée
		$sql = '
			SELECT ref
		...
		if (!empty($obj)) {
			...
			preg_match('/([a-z])([0-9]+)/i', $last_ref, $matches);
