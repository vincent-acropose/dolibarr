...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_crabe_proforma.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from crabe_proforma model
 */
...
/**
 *	Class to manage PDF invoice template crabe_proforma
 */
class pdf_crabe_proforma extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		if ($object->type == 4) $title=$outputlangs->transnoentities("Facture Proforma");
