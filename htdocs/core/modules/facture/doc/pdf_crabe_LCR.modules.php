...
//mb Gestion LCR  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			// 
			if (empty($object->mode_reglement_code) || $object->mode_reglement_code == 'LCR')
			{ */
				$curx=$this->marge_gauche;
				$cury=$posy-30;			   
				...
				$carac_emetteur = $outputlangs->convToOutputCharset($this->emetteur->nom);
				...
				$carac_emetteur .= "\n";
				$pdf->MultiCell(35, 4, $carac_emetteur,0,C);
