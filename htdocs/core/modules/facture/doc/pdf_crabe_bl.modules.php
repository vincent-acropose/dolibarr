...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_crabe_bl.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from crabe_bl model
 */
...
/**
 *	Class to manage PDF invoice template crabe_bl
 */
class pdf_crabe_bl extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "crabe_bl";
		$this->description = 'Modèle de facture PDF complet avec Bon de Livraison comme titre';
