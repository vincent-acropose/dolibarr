...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_crabe_print.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from crabe_print model
 */
...
/**
 *	Class to manage PDF invoice template crabe_print
 */
class pdf_crabe_print extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "crabe_print";
		$this->description = 'Modèle de facture PDF complet adapté au papier à en-tête de Travail Associé';
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		if ($conf->facture->dir_output)
		{
			...
			if (file_exists($dir))
			{
	            ...
	            $heightforfooter = $this->marge_basse + 38;	// Height reserved to output the footer (value include bottom margin)
