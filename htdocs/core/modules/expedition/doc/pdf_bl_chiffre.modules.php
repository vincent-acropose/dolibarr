 ...
 */
class pdf_bl_chiffre extends ModelePdfExpedition
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "BL Chiffré";
		$this->description = "Modèle de BL chiffré";
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		{
			$this->error=$langs->trans("ErrorConstantNotDefined","EXPEDITION_OUTPUTDIR");
			return 0;
		}
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $titlekey="SendingSheet")
	{
		...
		$pdf->SetXY($posx,$posy);
		$pdf->SetTextColor(0,0,60);
		$pdf->MultiCell(100, 4, $outputlangs->transnoentities("RefSending")." : " . $outputlangs->convToOutputCharset($object->ref), '', 'R');
