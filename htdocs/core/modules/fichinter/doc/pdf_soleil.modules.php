...
*/
	...
	{
		$showdetails=0;
		return pdf_pagefoot($pdf,$outputlangs,'FICHINTER_FREE_TEXT',$this->emetteur,$this->marge_basse-20,$this->marge_gauche,$this->page_hauteur,$object,$showdetails,$hidefreetext);
	}
