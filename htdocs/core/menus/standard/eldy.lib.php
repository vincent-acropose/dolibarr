	...
	if ($mainmenu)
	{
		...
		if ($mainmenu == 'products')
		{
			...
			if (! empty($conf->stock->enabled))
			{
                ...
                if ($conf->fournisseur->enabled) if (empty($leftmenu) || $leftmenu=="stock") $newmenu->add("/product/stock/replenish.php?salert=on", $langs->trans("Replenishment"), 1, $user->rights->stock->mouvement->creer && $user->rights->fournisseur->lire);
