 ...
 */
class modDolmessage extends DolibarrModules {
    ...
    function modDolmessage($db) {
        ...
        $this->description = "Message trace in dolibarr (email, instant message, ...)";
        ...
        $this->config_page_url = array("index.php@dolmessage");

        // Dependencies
        $this->depends = array('modoscimmods');  // List of modules id that must be enabled if this module is enabled
        $this->requiredby = array(); // List of modules id to disable if this one is disabled
        $this->phpmin = array(5, 0);     // Minimum version of PHP required by module
        $this->need_dolibarr_version = array(3, 0); // Minimum version of Dolibarr required by module
        $this->langfiles = array("dolmessage@dolmessage");
        ...
        $this->tabs = array(
            ...
            'thirdparty:TabMessage:dolmessage:@dolmessage:/dolmessage/tabs/thirdparty.message.php?socid=__ID__',
            'project:TabMessage2:dolmessage:@dolmessage:/dolmessage/tabs/projet.message.php?id=__ID__',
// 				    'contact:TabMessage:dolmessage:@dolmessage:/dolmessage/tabs/contact.message.php?id=__ID__',
        );
...
// exit;
    ...
    function load_tables() {
        return $this->_load_tables('/dolmessage/sql/');
    }
