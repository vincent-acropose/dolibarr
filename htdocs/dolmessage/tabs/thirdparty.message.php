...
dol_fiche_head($head, 'TabMessage', $title, 0, 'user');
...
$sql.= " JOIN  " . MAIN_DB_PREFIX . "element_element ee ON(targettype = 'dolmessage' AND fk_target = m.row_id AND sourcetype='societe' AND fk_source ='" . $socid . "' )  ";
