...
if ($resql)
{
	...
	print '<input class="flat" size="12" type="text" name="search_ref" value="'.GETPOST("search_ref").'">';
	print '</td>';
	print '<td class="liste_titre" align="left">';
	print '<input class="flat" size="15" type="text" name="search_ref_supplier" value="'.GETPOST("search_ref_supplier").'">';
	print '</td>';
	...
	print '<td class="liste_titre" align="left">';
	print '<input class="flat" size="25" type="text" name="search_libelle" value="'.GETPOST("search_libelle").'">';
	print '</td>';
	print '<td class="liste_titre" align="left">';
	print '<input class="flat" type="text" size="10" name="search_societe" value="'.GETPOST("search_societe").'">';
	print '</td><td class="liste_titre" align="right">';
	print '<input class="flat" type="text" size="10" name="search_montant_ht" value="'.GETPOST("search_montant_ht").'">';
	print '</td><td class="liste_titre" align="right">';
	print '<input class="flat" type="text" size="10" name="search_montant_ttc" value="'.GETPOST("search_montant_ttc").'">';
	...
	while ($i < min($num,$limit))
	{
		...
		print "</td>\n";
		print '<td nowrap="nowrap">'.$obj->facnumber."</td>";
		...
		print $supplierstatic->getNomUrl(1);
