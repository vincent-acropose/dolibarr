 ...
 */
class recurrencebox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "recurrence@recurrence";
    public $boxlabel;
    public $depends = array("recurrence");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/recurrence/class/recurrence.class.php";
