...
if ($id > 0 || ! empty($ref))
{
	...
	if ($object->fetch($id, $ref) > 0)
	{
		...
		$sql.= " from ".MAIN_DB_PREFIX."societe as s, ".MAIN_DB_PREFIX."element_contact as ec , ".MAIN_DB_PREFIX."socpeople as sp";
		...
		if ($resql)
		{
			...
			if ($num  > 0 )
			{
				...
				print "<table class=\"noborder\" width=\"100%\">";
				print '<tr class="liste_titre">';
				print_liste_field_titre($langs->trans("Ref"),$_SERVER["PHP_SELF"],"s.nom","",$param,"",$sortfield,$sortorder);
				print_liste_field_titre($langs->trans("Zip"),$_SERVER["PHP_SELF"],"s.zip","",$param,"",$sortfield,$sortorder);
				print_liste_field_titre($langs->trans("Town"),$_SERVER["PHP_SELF"],"s.town","",$param,"",$sortfield,$sortorder);
				print_liste_field_titre($langs->trans("Status"),$_SERVER["PHP_SELF"],"s.status","",$param,"",$sortfield,$sortorder);
				print "</tr>\n";
