					...
					foreach($product_fourn_list as $productfourn)
					{
						...
						print '<td align="right">';
                                                ...
                                                if($productfourn->fourn_remise_percent == 0){
                                                    ...
                                                    print "<strike>".price($productfourn->fourn_price) .'</strike> '. price($productfourn->fourn_price *(100 - $productfourn->fourn_remise_percent)/100);
                                                }
						print '</td>';
						...
						print '<td align="right">';
                                                if($productfourn->fourn_remise_percent == 0){
                                                    ...
                                                    print "<strike>".price($productfourn->fourn_unitprice) .'</strike> '. price($productfourn->fourn_unitprice *(100 - $productfourn->fourn_remise_percent)/100);
                                                }
