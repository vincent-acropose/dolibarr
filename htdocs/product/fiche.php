...
else
{
    ...
    if ($action == 'create' && ($user->rights->produit->creer || $user->rights->service->creer))
    {
        ...
        // Label
        print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input name="libelle" size="40" maxlength="255" value="'.addslashes(dol_escape_htmltag(GETPOST('libelle'))).'"></td></tr>';
