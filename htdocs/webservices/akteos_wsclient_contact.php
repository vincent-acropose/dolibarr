...
if ($action=='create')
{
	...
	'email'=> $_GET['email'],
	'civility_id'=> $_GET['civility_id'],
	'options_ct_origine'=> 'WEB',
	'options_ct_service' => $_GET['poste']
	);

	$parameters = array('authentication'=>$authentication,'contact'=>$newcontact);
	dol_syslog("Call method ".$WS_METHOD_CONTACT);
	$result = $soapclient->call($WS_METHOD_CONTACT,$parameters,$ns,'');
	/*if (! $result){
		print $soapclient->error_str;
		print "<br>\n\n";
		print $soapclient->request;
