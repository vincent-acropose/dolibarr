...
function getListOfThirdParties($authentication,$filterthirdparty)
{
    ...
    if (! $error)
    {
        $sql  = "SELECT s.rowid as socRowid, s.nom as ref, s.ref_ext, s.address, s.zip, s.town, c.label as country, s.phone, s.fax, s.url, s.client, s.fournisseur, s.remise_client, s.fk_stcomm, s.note_public, s.note_private, extra.*";
