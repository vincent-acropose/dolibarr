...
INSERT INTO `llx_mylist` (`code`, `label`, `titlemenu`, `mainmenu`, `leftmenu`, `perms`, `langs`, `fieldinit`, `querydo`, `elementtab`, 
 `fieldused`, `querylist`, `author`, `active`) VALUES
   ('FactureImpaye', 'Factures Impayes', 'Impayes', 'accountancy', 'customers_bills', '$user->rights->facture->lire', 'bills', NULL, NULL, 'UPDATE llx_facture set SET fk_statut=2, paye=1 WHERE rowid=#ROWID#',
...
('avec_contrat', 'Avec contrat', 'Adhérents avec contrat', 'members', 'members', '', '', NULL, NULL, NULL,
 ...
 'patas-monkey.com', 0),
('CommandeClient', 'Liste des commandes clients', 'CmdClient', 'commercial', 'orders', '$user->rights->commande->lire', 'orders:deliveries', NULL, NULL, 'Societe', 
 ...
 'patas-monkey.com', 0),
('FactureClient', 'Facture Client', 'myList', 'accountancy', 'customers_bills', '$user->rights->facture->lire', 'bills', NULL, NULL, NULL,
 '{"1":{"field":"f.rowid","name":"ref","alias":"","type":"List","elementfield":"Facture:/compta/facture/class/facture.class.php:facture:facnumber","align":"left","enabled":"true","visible":"true","filter":"false"},
   "2":{"field":"f.ref_client","name":"RefClient","alias":"","type":"Text","elementfield":"","align":"left","enabled":"true","visible":"false","filter":"false"},
   "3":{"field":"f.datef","name":"Date","alias":"","type":"Date","elementfield":"","align":"center","enabled":"true","visible":"true","filter":"true"},
   "4":{"field":"f.date_lim_reglement","name":"DateDue","alias":"","type":"Date","elementfield":"","align":"center","enabled":"true","visible":"true","filter":"true"},
   "5":{"field":"s.rowid","name":"Company","alias":"","type":"List","elementfield":"Societe::societe:nom","align":"left","enabled":"true","visible":"true","filter":"true"},
 ...
 'patas-monkey.com', 0),
('clientcamp', 'A recontacter', 'client à recontacter', 'companies', 'thirdparties', '', '', 'MYLISTFIELD1=7:MYLISTFIELD2=69:MYLISTFIELD3=2000', NULL, NULL,
 '{"1":{"field":"s.rowid","name":"client","alias":"client","type":"List","elementfield":"Societe::societe:nom","align":"left","enabled":"true","visible":"true","filter":"false"},
   "2":{"field":"s.nom","name":"name","alias":"name","type":"Text","elementfield":"","align":"left","enabled":"true","visible":"true","filter":"true"},
   "3":{"field":"s.town","name":"town","alias":"","type":"Text","elementfield":"","align":"left","enabled":"true","visible":"true","filter":"true"},
   "4":{"field":"s.zip","name":"zip","alias":"zip","type":"Text","elementfield":"","align":"left","enabled":"true","visible":"true","filter":"true"},
   "5":{"field":"s.phone","name":"phone","alias":"phone","type":"Text","elementfield":"","align":"left","enabled":"true","visible":"true","filter":"true"},
   "6":{"field":"count(*)","name":"nbfact","alias":"nbFact","type":"Number","elementfield":"","align":"left","enabled":"true","visible":"true","filter":"true"},
   "7":{"field":"sum(total_ttc)","name":"CA","alias":"CA","type":"Number","elementfield":"","align":"right","enabled":"true","visible":"true","filter":"false"}}',
 ...
 'patas-monkey.com', 1),
 ('product', 'Liste des produits', 'myList', 'products', 'product', '$user->rights->produit->lire', 'product', NULL, NULL, NULL,
 '{"1":{"field":"p.rowid","name":"ref","alias":"","type":"List","elementfield":"Product:/product/class/product.class.php","align":"left","enabled":"true","visible":"true","filter":"true"},
   ...
   "3":{"field":"p.tms","name":"DateModif","alias":"","type":"Date","elementfield":"","align":"left","enabled":"true","visible":"true","filter":"true"},
   "4":{"field":"p.price_ttc","name":"pricettc","alias":"","type":"Number","elementfield":"","align":"right","enabled":"true","visible":"true","filter":"true"},
   "5":{"field":"p.stock","name":"stock","alias":"","type":"Number","elementfield":"","align":"right","enabled":"true","visible":"true","filter":"true"},
   "6":{"field":"p.seuil_stock_alerte","name":"alertstock","alias":"","type":"Number","elementfield":"","align":"right","enabled":"true","visible":"true","filter":"true"},
   "7":{"field":"p.tosell","name":"tosell","alias":"","type":"Boolean","elementfield":"","align":"center","enabled":"true","visible":"true","filter":"true"},
   "8":{"field":"p.tobuy","name":"tobuy","alias":"","type":"Boolean","elementfield":"","align":"center","enabled":"true","visible":"true","filter":"true"},
   "9":{"field":"p.pmp","name":"pmp","alias":"","type":"Number","elementfield":"","align":"right","enabled":"true","visible":"true","filter":"true"}}', 
 'FROM llx_product as p LEFT JOIN llx_product_extrafields as extra ON p.rowid = extra.fk_object WHERE p.fk_product_type = 0 AND p.entity IN (1)', 
 'patas-monkey.com', 0),
('PropalClient', 'Liste devis/propositions', 'myList', 'commercial', 'propals', '$user->rights->propale->lire', 'propal', NULL, NULL, NULL,
 ...
 'patas-monkey.com', 0),
('service', 'Liste des Services', 'myList', 'products', 'service', '$user->rights->service->lire', 'products', NULL, NULL, NULL,
 '{"1":{"field":"p.rowid","name":"ref","alias":"","type":"List","elementfield":"Product:/product/class/product.class.php","align":"left","enabled":"true","visible":"true","filter":"true"},
   "2":{"field":"p.label","name":"label","alias":"","type":"Text","elementfield":"","align":"left","enabled":"true","visible":"true","filter":"true"},
