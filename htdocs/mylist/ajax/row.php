...
top_httphead();
	...
	// list to update
	$code=GETPOST('code','string');

	dol_syslog("AjaxRow roworder=".$roworder." fk_element=".$code, LOG_DEBUG);
	...
	{
		$newArray=$table_element_line[$value];
		$newArrays[$value] = $newArray;
	}
	$object->listsUsed = $newArrays;
	//$ret = $object->update($user);
	$ret = $object->updateField($user,$keyField)
?>
