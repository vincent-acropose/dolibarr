 ...
 */
class cliagcaudiobox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "cliagcaudio@cliagcaudio";
    public $boxlabel;
    public $depends = array("cliagcaudio");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/cliagcaudio/class/cliagcaudio.class.php";
