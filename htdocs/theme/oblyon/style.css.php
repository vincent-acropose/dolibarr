...
div.float, .left { float: <?php print $left; ?> !important; }
div.floatright, .right { float: <?php print $right; ?> !important; }

div.inline-block { display: inline-block; }
.nowrap { white-space: <?php print ($dol_optimize_smallscreen?'normal':'nowrap'); ?>; }
...
.impair:hover {
	<?php if ($colorbacklineimpairhover) { 
		if ($usecss3) { ?>
			background-color: rgb(<?php echo $colorbacklineimpairhover; ?>);
		<?php } else { ?>
...
.pair:hover {
	<?php if ($colorbacklinepairhover) { ?>
		<?php if ($usecss3) { ?>
			background-color: rgb(<?php echo $colorbacklinepairhover; ?>);
		<?php } else { ?>
			background-color: #fafafa;
		<?php } ?>
	<?php } ?>
...
tr.box_titre {
	background-color: <?php print $bgotherbox; ?>;
