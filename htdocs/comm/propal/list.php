...
if ($result)
{
	...
	print $form->selectarray('search_delai_realisation', $extrafield->attribute_param['delai_realisation']['options'], $search_delai_realisation, 1, 0, 0, '', 0, 0, 0, 0, '', 1);
	print '</td>';
	...
	print $form->selectarray('search_probability', $extrafield->attribute_param['proba']['options'], $search_probability, 1, 0, 0, '', 0, 0, 0, 0, '', 1);
	print '</td>';
	// Author
	print '<td class="liste_titre" align="center">';
	...
	while ($i < min($num,$limit))
	{
		...
		// Delai réalisation
		print '<td align="center">'.$extrafield->attribute_param['delai_realisation']['options'][$objp->delai_realisation]."</td>\n";
