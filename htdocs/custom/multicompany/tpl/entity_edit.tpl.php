...
<?php if (! empty($conf->global->MULTICOMPANY_PROJECT_SHARING_ENABLED)) { ?>
<tr class="liste_titre">
        <td colspan="2"><?php echo $langs->trans("ProjectSharing"); ?></td>
</tr>

<?php $var=!$var; ?>
<tr <?php echo $bc[$var]; ?>>
        <td valign="top"><?php echo $langs->trans("ProjectSharingDescription"); ?></td>
        <td><?php echo $this->tpl['multiselect_shared_project']; ?></td>
</tr>
<?php } ?>
