...
class mybox extends ModeleBoxes
{
    ...
    public $boximg = "expressdelivery@expressdelivery";
    public $boxlabel;
    public $depends = array("expressdelivery");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/expressdelivery/class/expressdelivery.class.php";
