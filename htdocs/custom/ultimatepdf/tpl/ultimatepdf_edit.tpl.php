...
<?php global $mysoc; ?>
<?php $urllogo=DOL_URL_ROOT.'/viewimage.php?cache=1&amp;modulepart=companylogo&amp;file='.urlencode($mysoc->logo); ?>
	...
	<td>
		<div id="container" class="ui-widget-content">
			<div class="ui-state-active"> 
				<img id="resizable-1" src="<?php echo (empty($urllogo)?DOL_URL_ROOT.'/theme/common/nophoto.jpg':$urllogo); ?>" />
			</div>
		</div>
	</td>
...
<tr <?php echo $bc[$var]; ?>>
	...
	<td><input name="freetextfontsize" id="freetextfontsize" class="changeMe" size="30" value="<?php echo $this->tpl['select_freetextfontsize']; ?>" /></td><td id="freetextfontsize_text" style="font-size:<?php echo $this->tpl['select_freetextfontsize'].'px'; ?>"><?php echo $langs->trans("Lorem ipsum dolor sit amet, consectetur adipiscing elit"); ?></td><td><button type="button" id="maj_freetext"><?php echo $langs->trans("Update"); ?></button></td>
</tr>
<br>
<?php $var=!$var; ?>
<tr <?php echo $bc[$var]; ?>>
