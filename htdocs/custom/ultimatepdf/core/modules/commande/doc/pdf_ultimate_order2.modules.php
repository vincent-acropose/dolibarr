...
/**
 *	\class      pdf_ultimate_order2
 *	\brief      Classe permettant de generer les commandes au modele ultimate_order2
 */
class pdf_ultimate_order2 extends ModelePDFCommandes
{
	var $db;
    var $name;
    var $description;
