...
/**
 *	\file       core/modules/commande/doc/pdf_ultimate_proforma1.modules.php
 *	\ingroup    commande
 *	\brief      Fichier de la classe permettant de generer les commandes au modele ultimate_proforma1 
 */
...
/**
 *	\class      pdf_ultimate_proforma1
 *	\brief      Classe permettant de generer les commandes au modele ultimate_proforma1
 */
class pdf_ultimate_proforma1 extends ModelePDFCommandes
{
	var $db;
    var $name;
    var $description;
	...
	function _tableau(&$pdf, $tab_top, $tab_height, $nexY, $outputlangs, $hidetop=0, $hidebottom=0)
	{
        ...
        if (empty($hidetop))
        {
        	 $pdf->SetXY ($this->postotalht-$this->marge_droite-6, $tab_top);
