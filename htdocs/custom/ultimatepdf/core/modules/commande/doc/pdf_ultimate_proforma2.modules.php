...
/**
 *	\file       core/modules/commande/doc/pdf_ultimate_proforma2.modules.php
 *	\ingroup    commande
 *	\brief      Fichier de la classe permettant de generer les commandes au modele ultimate_proforma2 
 */
...
/**
 *	\class      pdf_ultimate_proforma2
 *	\brief      Classe permettant de generer les commandes au modele ultimate_proforma2
 */
class pdf_ultimate_proforma2 extends ModelePDFCommandes
{
	var $db;
    var $name;
    var $description;
		...
		if ($conf->commande->dir_output)
		{
			...
			{	
				 ...
				 for ($i = 0 ; $i < $nblignes ; $i++)
                {
					...
					{
						$up_after = price(0);
						$pdf->SetXY ($this->posxupafter-2, $curY);
						$pdf->MultiCell($this->posxqty-$this->posxupafter+2, 4, $up_after, 0, 'R');
					}
					else
					{
						if ($object->lines[$i]->remise_percent > 0)
						{
							...
							$pdf->SetXY ($this->posxupafter-2, $curY);
							$pdf->MultiCell($this->posxqty-$this->posxupafter+2, 4, price($up_after), 0, 'C');
						}
					}
