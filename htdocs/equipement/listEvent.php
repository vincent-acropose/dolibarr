...
if ($result)
{
	...
	print '<td class="liste_titre"><input type="text" class="flat" name="search_refprojet" value="'.$search_refprojet.'" size="10"></td>';
	...
	while ($i < min($num, $limit))
	{
		...
		print '<td align="right">'.$langs->trans($objp->equipevttypelibelle).'</td>';
		print "</tr>\n";
