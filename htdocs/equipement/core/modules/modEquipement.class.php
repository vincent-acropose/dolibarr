<?php
 /* Copyright (C) 2012-2015	Charles-Fr BENKE	 <charles.fr@benke.fr>
 *
...
class modEquipement extends DolibarrModules
{
	...
	*/
	function modEquipement($db)
	{
		...
		$this->langfiles = array("products","companies","equipement@equipement");

		// Config pages
		$this->config_page_url = array("equipement.php@equipement");
		...
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=products,fk_leftmenu=equipement',
					...
					'position'=>110,
					'enabled'=>'1',
					'perms'=>'$user->rights->equipement->lire',
					'target'=>'',
					'user'=>2);	
		$r++;
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=products,fk_leftmenu=equipement',
		...
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=products,fk_leftmenu=equipement',
					...
					'langs'=>'equipement@equipement',
					'position'=>110,
					'enabled'=>'$user->rights->equipement->lire',
					'perms'=>'1',
					'target'=>'',
					'user'=>2);
		...
		'tabsqlsort'=>array("code ASC, libelle ASC","code ASC, libelle ASC"), 'tabfield'=>array("code,libelle","code,libelle"),
		'tabfieldvalue'=>array("code,libelle", "code,libelle"),	'tabfieldinsert'=>array("code,libelle", "code,libelle"), 
		...
		'e.rowid'=>"Equipement",'e.ref'=>"Equipement",'e.fk_product'=>"product",'e.numversion'=>"Equipement",'e.datec'=>"Equipement",'e.fk_statut'=>'Equipement',
		'e.description'=>"Equipement",'e.dateo'=>"Equipement",'e.datee'=>"Equipement",'e.fk_etatequipement'=>"Equipement",'e.numimmocompta'=>"Equipement",
		'e.fk_soc_fourn'=>"company",'e.fk_soc_client'=>"company",'e.fk_facture_fourn'=>"invoice",'e.fk_facture'=>"invoice",'e.fk_entrepot'=>"stock",
		'ee.rowid'=>'Equipement','ee.datec'=>"Equipement",'ee.duree'=>"Equipement",'ee.description'=>"Equipement",'ee.fk_equipementevt_type'=>"Equipement",
		'ee.dateo'=>"Equipement",'ee.datee'=>"Equipement",'ee.fulldayevent'=>"Equipement",'ee.total_ht'=>"Equipement",
		...
		$this->import_tables_array[$r]=array('e'=>MAIN_DB_PREFIX.'equipement');
...
//
		...
		$this->import_tables_array[$r]=array('ee'=>MAIN_DB_PREFIX.'equipementevt');
