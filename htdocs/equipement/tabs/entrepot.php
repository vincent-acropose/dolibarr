...
print "</table>";
print "<br>";
print_barre_liste($langs->trans("ListOfEquipements"), $page, "entrepot.php",$urlparam,$sortfield,$sortorder,'',$num);
...
if ($result)
{
	...
	print '<tr><td width=100px valign=top align=left rowspan='.($num+1).'>';
	print select_produitEntrepot($search_refProduct, $entrepotid, "search_refProduct",1,1,25);
	print '</td>';
